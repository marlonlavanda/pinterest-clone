    ...
    >
      ...
      <div class="flex items-center w-full ">
        <button
          type="button"
          name="button"
          class="ml-auto mr-2 rounded-full w-8 h-8 flex items-center justify-center text-dark bg-white font-semibold opacity-75 hover:opacity-100"
        >
        ...
        <button
          type="button"
          name="button"
          class="rounded-full w-8 h-8 flex items-center justify-center text-dark bg-white font-semibold opacity-75  hover:opacity-100"
        >
