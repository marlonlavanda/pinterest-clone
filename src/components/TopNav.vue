<template>
  <div class="px-3 py-4 flex items-center justify-between">
    <div class="flex items-center">
      ...
      <button
      :class="`${selectedTab === item.key ? 'bg-dark text-white' : 'text-dark hover:bg-light' } rounded-full py-3 px-4 font-semibold` "
    ...
    <div class="flex-grow realative">
      <span class="material-icons absolute mt-3 ml-3 text-muted">search</span>
      <input class="w-full hover:bg-lightHover rounded-full bg-light py-3 pr-3 pl-10" placeholder="Search" type="text" name="" value="">
    </div>
    <div class="flex items-center">
